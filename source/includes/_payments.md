...
| payee_id                  | string  | **(requerido, se não enviar payee_attributes)** identificador do beneficiário (caso seja fornecido, o parâmetro payee_attributes será ignorado)                                  |
| payee_attributes*         | object  | **(requerido, se não enviar payee_id)** atributos para a criação de um novo beneficiário ou atualização de um beneficiário existente com o mesmo documento (national_identifier) |
