...
|-------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|---------|--------------------|
| without_remittance                  | Pagamento criado, mas ainda não teve o arquivo de remessa gerado pelo usuário                                                                                                                                |          |    X    |          X         |
...
| registered                          | O banco informou que o pagamento foi devidamente registrado e será efetivado na data cadastrada                                                                                                              |    X     |         |                    |
| registered_with_error               | O banco não conseguiu processar a instrução de registro do pagamento e portanto existe a garantia de que não será efetivado                                                                                  |          |    X    |          X         |
| canceled                            | Pagamento previamente registrado no banco foi cancelado antes de ser efetivado                                                                                                                               |    X     |         |                    |
