...
| company_ids                  | array of integers | **(requerido, veja a nota acima)** Lista com os ids dos estabelecimentos das configurações para as quais devem ser criados os Arquivos CNAB de Remessa                                                                 |
| company_national_identifiers | array of strings  | **(requerido, veja a nota acima)** Lista com os números de documento dos estabelecimentos das configurações para as quais devem ser criados os Arquivos CNAB de Remessa                                                |
| payee_ids                    | array of integers | (DEPRECATED: use company_ids) **(requerido, veja a nota acima)** Lista com os ids dos estabelecimentos das configurações para as quais devem ser criados os Arquivos CNAB de Remessa                                   |
| payee_national_identifiers   | array of strings  | (DEPRECATED: use company_national_identifiers) **(requerido, veja a nota acima)** Lista com os números de documento dos estabelecimentos das configurações para as quais devem ser criados os Arquivos CNAB de Remessa |
